...
int main(){
    ...
    try{
        cout<<"Ingrese coeficiente del termino cuadratico(a) [ax^2 + bx + c]: ";cin>>a;
        if(a == 0) throw Primer_coeficiente_cero();
        cout<<"Ingrese coeficiente del termino lineal(b) [ax^2 + bx + c]: ";cin>>b;
        cout<<"Ingrese coeficiente del termino independiente(c) [ax^2 + bx + c]: ";cin>>c;

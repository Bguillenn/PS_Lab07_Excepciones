...
int main(){
    ...
    //Probaremos nuestra clase de InputException que lanzaremos si nuestro numero no
    ...
    //Probaremos nuestro ProcessorException que sera para comprobar que no se intente
    ...
    //Probaremos nuestro OutputException en este caso simularemos limitar la cantidad de lineas a imprimir
